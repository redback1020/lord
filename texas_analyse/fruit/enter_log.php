...
<script src="../js/fruit_enter.js"></script>
...
<body class="hold-transition skin-blue sidebar-mini" style="margin: 30px;">
<div class="wrapper" ng-controller="FruitEnterLogController">
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">水果机玩家进场日志</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
