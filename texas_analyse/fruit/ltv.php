...
<script src="../js/fruit_ltv.js"></script>
...
<div class="wrapper" ng-controller="StatFruitLtvController">
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">水果机新增用户LTV</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                            ...
                            <div class="col-sm-12">
                                <table id="example1" class="table table-bordered  dataTable table-hover" role="grid"
                                    ...
                                    <tr ng-repeat="item in data">
                                        ...
                                        <td>{{item.today_bet}}</td>
                                        <td>{{item.today_win}}</td>

                                        <td>{{item.today_recovery}}</td>
                                        <td>{{item.today_recovery_rate}}%</td>

                                        <td>{{item.nextday_recovery}}</td>
                                        <td>{{item.nextday_recovery_rate}}%</td>

                                        <td>{{item.day3_7recovery}}</td>
                                        <td>{{item.day3_7recovery_rate}}%</td>

                                        <td>{{item.day8_30recovery}}</td>
                                        <td>{{item.day8_30recovery_rate}}%</td>

                                        <td>{{item.day31_60recovery}}</td>
                                        <td>{{item.day31_60recovery_rate}}%</td>
