...
<script src="../js/fruit_play.js"></script>
...
<div class="wrapper" ng-controller="FruitPlayLogController">

    <div php-include="static/main-header"></div>
    <div php-include="static/main-siderbar"></div>
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">水果机玩家出分日志</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
