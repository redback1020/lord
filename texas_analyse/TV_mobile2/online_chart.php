...
if($type == "day"){
	...
	$sql = "select sum(num) as snum,count(*) as cn,date(add_time) as dd from mobile_online where add_time >= '".$start."' and add_time<'".$date." 23:59:59' group by dd order by dd desc"; 
	...
	$sql = "select * from mobile_online where date(add_time) = '".$date."'"; 
	$row = $db -> query($sql) -> fetchAll();
	foreach($row as $val){
	...
	$sql = "select * from mobile_online where date(add_time) = '".$date2."'"; 
	$row = $db -> query($sql) -> fetchAll();
	foreach($row as $val){
	...
	$sql = "select * from mobile_online where date(add_time) = '".$date3."'"; 
	$row = $db -> query($sql) -> fetchAll();
	foreach($row as $val){
...
$(document).ready(function(){
  ...
  var line1=[['23-May-08', 578.55], ['20-Jun-08', 566.5], ['25-Jul-08', 480.88], ['22-Aug-08', 509.84],
	...
	var line1 = [['00:00',1],['00:05',2],['00:10',4],['00:15',6],['00:20',5],['00:25',3],['00:30',2],['10:40',9],['00:40',9],['23:40','-']];
