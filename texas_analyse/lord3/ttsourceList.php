...
if ($isAjax) {
	...
	$where = "1=1 ";
	$sql = "SELECT * FROM `lord_list_ttesksource` WHERE {$where} ORDER BY `sort`,`id` LIMIT {$pageIndex}, {$pageSize}";
	...
	$.post("ttsourceList.php",{
		...
		if(result!=null && result!=""){
			...
			for(var i=0;i<dataList.data.length;i++){
				...
				// dataListHtml += "<td><a href='#' onclick='linkto(this,\"ttsourceAdd.php?type=modify&id="+o.id+"\")'>修改</a>"+(o.is_del>0?"":"&nbsp;&nbsp;<a href='#' onclick='ajaxto(this,\"ttsourceAdd.php?type=delete&id="+o.id+"\")'>删除</a>")+"</td>";
				// dataListHtml += "<td><a href='#' onclick='linkto(this,\"ttsourceAdd.php?type=modify&id="+o.id+"\")'>修改</a>"+"</td>";
				dataListHtml += "<td>&nbsp;</td>";
				dataListHtml += "</tr>";
			}
