...
if ($ispost) {
	...
	if ( !$errno ) {
		header('Location: luckyDrawFileList.php');
	}
	else {
		echo $res;
		exit;
...
<fieldset>
	<legend>奖品图片-<?php if($type=='add'){?>创建<?php }else{?>编辑<?php }?></legend>
	<form action="luckyDrawFileAdd.php" method="post">
		...
		<table class="table table-bordered table-condensed table-hover">
			...
			<tr>
				...
				<td>暂不支持，目前需要手动上传到CDN的目录lucky_draw或prize_big(暂不支持)下</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
