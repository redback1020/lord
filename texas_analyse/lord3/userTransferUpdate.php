...
//查旧账号数据
$sql = "select u.uid,u.cool_num,u.coins,a.login,a.matches,a.win,u.coupon,u.nick from lord_game_user u left join lord_game_analyse a on u.uid=a.uid where u.cool_num = {$cool_num2}";
$old = $db->query($sql)->fetch(PDO::FETCH_ASSOC);

//查新账号数据
$sql = "select u.uid,u.cool_num,u.coins,a.login,a.matches,a.win,u.coupon,u.nick from lord_game_user u left join lord_game_analyse a on u.uid=a.uid where u.cool_num = {$cool_num1}";
