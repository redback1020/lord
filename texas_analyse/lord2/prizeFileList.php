...
if ($isAjax) {
	...
	$where = "1=1 ";
	if ($path == 'all') $where .= " AND (f.`path`='prize_small')";
		...
		if(result!=null && result!=""){
			...
			for(var i=0;i<dataList.data.length;i++){
				...
				if(o.ver_del>0){
					...
					dataListHtml += "<td><a href='#' onclick='ajaxto(this,\"prizeFileAdd.php?type=delete&id="+o.id+"\")'>删除</a>&nbsp;&nbsp;<a href='#' onclick='linkto(this,\"prizeFileAdd.php?type=modify&id="+o.id+"\")'>修改</a><br><a href='#' onclick='viewimg(this,\""+o.path+"/"+o.fileid+"\")'>查看图片</a></td>";
				}
				dataListHtml += "</tr>";
			}
...
<fieldset>
	...
	<div class="row">
		...
		<div span="span1" style="float:right;">
			...
			<input type="button" value="创&nbsp;&nbsp;建" onclick="linkto(this,'prizeFileAdd.php')" class="btn"/>
		</div>
	</div>
</fieldset>
