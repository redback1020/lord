	...
	<div>
		<table class="table table-bordered table-condensed table-hover">
			<tr class="info">			
				...
				<td nowrap id="matcha"><strong><a style="cursor: pointer" onclick="query('a.match','matcha')">match</a></strong></td>
				<td nowrap id="matchd" style="display:none"><strong><a style="cursor: pointer" onclick="query('a.match','matchd')">match</a></strong></td>
