...
function showLayer(layer){
 ...
 <body>
	...
	$obj = fetch_page('http://112.124.4.59:8200/onlines',array('sign'=>'jlfsd87912hjk312h90f!@fsjdkl!23','count'=>1));
	...
	$hall = $obj['hall']; 
	$flag1 = $flag2 = $flag3 = 0;
	$obj = fetch_page('http://112.124.4.59:8200/onlines',array('sign'=>'jlfsd87912hjk312h90f!@fsjdkl!23'));
	...
	<div>
		<table class="table table-bordered table-condensed table-hover" style="font-size:12px;">
			...
			//$obj = fetch_page('http://112.124.4.59:8000/onlines',array('sign'=>'jlfsd87912hjk312h90f!@fsjdkl!23'));
