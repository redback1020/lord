...
$data['_type'] = $type;
$data['_file'] = 'data_ttesksource_list';
$data['_class'] = 'file';
$data['mysql'] = 'SELECT `id`, `typeid`, `type`, `name` FROM `lord_list_ttesksource` ORDER BY `sort`,`id`';//决定文件中有哪行数据、哪些字段
$data['redis'] = 'lord_list_ttesksource';
//hosts
