...
$data['_type'] = $type;
$data['_file'] = 'data_ttesk_list';
$data['_class'] = 'file';
$data['mysql'] = 'SELECT `id`, `rooms`, `channels`, `users`, `typeid`, `conds`, `prob`, `coins`, `coupon` FROM `lord_list_ttesk` ORDER BY `sort`,`id`';//决定文件中有哪行数据、哪些字段
$data['redis'] = 'lord_list_ttesk';
$data['explode'] = array('rooms','channels','users','conds');
//hosts
